...
- `<module.path>` is a dotted path resolved to a `.py` file relative to the current directory. To run the file `modules/deep-learning/mnist.py`, use `modules.deep-learning.mnist`.
