...
- `<module.path>` is a dotted path resolved to a `.py` file relative to the current directory. To run the file `computer-vision/cnn_mnist.py`, use `modules.deep-learning.mnist`.
